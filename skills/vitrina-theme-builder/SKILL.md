...
**Accent χρώμα σε ανοιχτό φόντο ≠ accent σε κουμπί.** Το ίδιο amber έδινε 2,42
αντίθεση ως κείμενο. Κράτα **δύο** μεταβλητές: μία για φόντο κουμπιών, μία πιο
σκούρα μόνο για κείμενο.
