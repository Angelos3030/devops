...
TRADES: tuple[tuple[str, str], ...] = (
    ...
    ("Φυσικοθεραπευτήριο", "φυσικοθεραπ|physiotherap"),
    ("Ιατρείο", r"ιατρειο|γιατρ|\bιατρ|παθολογ|καρδιολογ|παιδιατρ|δερματολογ|ψυχολογ|διαιτολογ|διατροφολογ"),
    ("Κτηνιατρείο", r"κτηνιατρ|vet\b"),
    ("Φαρμακείο", r"φαρμακει"),
    ("Ινστιτούτο αισθητικής", r"αισθητικ|beauty|\\bspa\\b|περιποιησ"),
    ("Μασάζ", r"μασαζ|massage"),
    ("Γυμναστήριο", r"γυμναστηρ|gym|fitness|pilates|πιλατες|crossfit|yoga|γιογκα|reformer"),
    ...
    ("Ξενοδοχείο", r"ξενοδοχ|hotel|δωματ|καταλυμ|airbnb|ενοικιαζομεν"),
    ("Κατάστημα", r"καταστημ|μαγαζ|\\bshop\\b|store|boutique|μπουτικ"),
)
