...
export const TEMPLATE_META = {
  ...
  'area-first': { label: 'Περιοχές Πρώτα', desc: 'Οι περιοχές εξυπηρέτησης μπροστά — για τοπικό τεχνίτη.', category: 'Τεχνικά επαγγέλματα', primary: 'trade', verticals: ["trade"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  'bigspring-advisory': { label: 'Συμβουλευτική', desc: 'Σοβαρό και δομημένο, με υπηρεσίες και αίτημα ραντεβού.', category: 'Επαγγελματικές υπηρεσίες', primary: 'professional', verticals: ["dentist", "doctor", "professional", "realestate"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  canvas: { label: 'Καμβάς', desc: 'Ήσυχο editorial με μεγάλη εικόνα και serif αφήγηση.', category: 'Ευέλικτο', primary: 'farm', verticals: ["aesthetics", "dentist", "doctor", "farm", "garage", "massage", "pet", "pharmacy", "professional", "realestate", "retail", "rooms", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
  'chapter-snap': { label: 'Κεφάλαια', desc: 'Κάθε ενότητα γεμίζει την οθόνη — σαν κεφάλαια βιβλίου.', category: 'Τουρισμός & διαμονή', primary: 'rooms', verticals: ["beauty", "rooms"], generic: false, customizable: { palette: false, fontPair: false } },
  cinematic: { label: 'Κινηματογραφικό', desc: 'Σκούρο, γεμάτο φωτογραφία, με μεγάλη χειρόγραφη τυπογραφία.', category: 'Ευέλικτο', primary: 'food', verticals: ["aesthetics", "beauty", "cafe", "dentist", "doctor", "farm", "food", "garage", "gym", "massage", "pet", "professional", "realestate", "retail", "rooms", "trade", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
  'clean-work': { label: 'Καθαρή Δουλειά', desc: 'Λιτό και αξιόπιστο, με υπηρεσίες, περιοχές και άμεση κλήση.', category: 'Τεχνικά επαγγέλματα', primary: 'trade', verticals: ["garage", "trade", "wood"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  'constra-build': { label: 'Κατασκευές', desc: 'Έργα, στάδια και προσφορά — για κατασκευαστικό ή τεχνικό γραφείο.', category: 'Τεχνικά επαγγέλματα', primary: 'trade', verticals: ["trade", "wood"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  'directory-index': { label: 'Ευρετήριο Υπηρεσιών', desc: 'Για πολλές υπηρεσίες: ταξινομημένος κατάλογος με γρήγορη εύρεση.', category: 'Υγεία', primary: 'professional', verticals: ["dentist", "professional", "realestate"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  'educenter-campus': { label: 'Εκπαιδευτικό Κέντρο', desc: 'Προγράμματα, καθηγητές και εγγραφή σε καθαρή δομή.', category: 'Επαγγελματικές υπηρεσίες', primary: 'professional', verticals: ["professional"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  'freight-lane': { label: 'Μεταφορές', desc: 'Δρομολόγια, κάλυψη και χρόνοι, με καθαρό αίτημα προσφοράς.', category: 'Τεχνικά επαγγέλματα', primary: 'trade', verticals: ["garage", "trade", "wood"], generic: false, customizable: { palette: false, fontPair: false } },
  ...
  grid: { label: 'Grid', desc: 'Βασικό αρχέτυπο πλέγματος. Εσωτερική υποδομή συμβατότητας.', category: 'Εσωτερικά', primary: 'retail', verticals: ["dentist", "doctor", "farm", "garage", "gym", "pet", "pharmacy", "professional", "realestate", "retail", "rooms", "trade", "wood"], generic: true, internal: true, customizable: { palette: true, fontPair: true } },
  ...
  infinite: { label: 'Συνεχές', desc: 'Αδιάκοπη ροή φωτογραφιών, χωρίς ορατές τομές ενοτήτων.', category: 'Ευέλικτο', primary: 'garage', verticals: ["aesthetics", "beauty", "farm", "food", "garage", "gym", "massage", "pet", "pharmacy", "professional", "retail", "rooms", "trade", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
  ...
  living: { label: 'Καθημερινό', desc: 'Ζεστό και οικείο, με τη φωτογραφία του προϊόντος μπροστά.', category: 'Ευέλικτο', primary: 'massage', verticals: ["aesthetics", "beauty", "cafe", "dentist", "doctor", "farm", "food", "garage", "gym", "massage", "pet", "pharmacy", "professional", "realestate", "retail", "rooms", "trade", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
  ...
  marble: { label: 'Μάρμαρο', desc: 'Λευκό και λιτό, με μία εικόνα και πολύ αέρα γύρω της.', category: 'Ευέλικτο', primary: 'pharmacy', verticals: ["aesthetics", "dentist", "doctor", "massage", "pharmacy", "professional", "realestate", "rooms"], generic: true, customizable: { palette: true, fontPair: true } },
  ...
  quiet: { label: 'Ησυχία', desc: 'Σχεδόν μόνο τυπογραφία. Ο μέγιστος δυνατός αέρας.', category: 'Ευέλικτο', primary: 'pharmacy', verticals: ["aesthetics", "beauty", "cafe", "dentist", "doctor", "farm", "food", "garage", "gym", "massage", "pet", "pharmacy", "professional", "realestate", "retail", "rooms", "trade", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
  ...
  'type-gallery': { label: 'Τυπογραφική Γκαλερί', desc: 'Η τυπογραφία κάνει τη δουλειά· η εικόνα υποστηρίζει.', category: 'Ευέλικτο', primary: 'gym', verticals: ["aesthetics", "bakery", "beauty", "cafe", "farm", "food", "garage", "gym", "massage", "pet", "pharmacy", "professional", "retail", "rooms", "trade", "wood"], generic: true, customizable: { palette: true, fontPair: true } },
