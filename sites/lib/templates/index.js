...
import AegisDental from './AegisDental'
...
export const TEMPLATE_META = {
  'aegis-dental': { label: 'Aegis Dental', desc: 'Πρωτότυπο master theme για οδοντιατρείο: ήρεμη τυπογραφία, scroll-snap gallery χωρίς JavaScript, τρεις σκόπιμες συνθέσεις.', category: 'dentist', customizable: { palette: false, fontPair: false } },
  'modern-musician': { label: 'Studio Signature', desc: 'Πιστό port του Modern Musician: serif τυπογραφία, κάρτες έργων με ετικέτα τύπου, ήρεμη παλέτα.', category: 'music', customizable: { palette: false, fontPair: false } },
