...
Instagram feed. Ένας φούρνος δεν είναι κατάστημα με καλάθι.

> ⚠️ **Διόρθωση 15/8:** εδώ γράφτηκε αρχικά «το Vitrina δεν έχει ούτε καλάθι ούτε
> τιμές». Το **δεύτερο είναι λάθος** — το `sites/lib/demoData.js` έχει
> `priceType/priceFrom/price/duration` και `inventoryOptions` με τιμή, κατηγορία
> και διαθεσιμότητα. Λόγος απόρριψης παραμένει **μόνο το καλάθι/ταμείο**.
> Λεπτομέρειες: [`v01-restaurant-cafe-DISCOVERY.md`](v01-restaurant-cafe-DISCOVERY.md).
