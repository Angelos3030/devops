...
**Τελευταία ενημέρωση:** 2026-08-15 (μετά τη διόρθωση του worker)

| # | Vertical | PORT_OK | Κατάσταση | Εξαιρέσεις | Ημ/νία |
|---|---|---|---|---|---|
| 1 | Restaurant / taverna | **8 υποψήφιοι** | 🔄 ξανατρέχθηκε | 0 → 8 μετά τη διόρθωση· **εκκρεμεί έλεγχος καταλληλότητας** | 15/8 |
| 2 | Cafe / bakery | **9 υποψήφιοι** | 🔄 ξανατρέχθηκε | 0 → 9 μετά τη διόρθωση· **εκκρεμεί έλεγχος καταλληλότητας** | 15/8 |
...
⚠️ **Προσοχή στην ερμηνεία:** «υποψήφιοι» ≠ «PORT_OK». Οι αριθμοί δείχνουν ότι το
φίλτρο δεν πετάει πια σωστό υλικό — αλλά οι περισσότεροι είναι **γενικά business
templates** της Themefisher (Brandi, Bexer, Bizcraft…), όχι vertical-specific.
Εκκρεμεί για καθέναν: **επαλήθευση άδειας στο repo** (Claude) και **κρίση
καταλληλότητας από πραγματική αποτύπωση** (Claude). Μέχρι να γίνουν αυτά, το
PORT_OK παραμένει **3**.
