...
CSS = '''
  ...
  @media (max-width:899px){
    ...
    .fl-end::before{ content:""; bottom:auto; height:37px; }  /* 16 padding + 21 ως το κέντρο */
    .fl-end::after{ left:17.5px; top:4px; transform:rotate(135deg); }  /* ίδιο άκρο, κάτω */
    .fl{ gap:9px; }
    .fl-art{ height:54px; }
    .fl-t{ font-size:13px; }
    ...
    .fl-end .fl-ok{ width:42px; height:42px; margin:0; }
